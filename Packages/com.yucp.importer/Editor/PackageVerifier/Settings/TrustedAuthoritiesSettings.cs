...
namespace YUCP.Importer.Editor.PackageVerifier.Settings
{
    /// <summary>
    ...
    {
        public const string DefaultTrustedUrl = "https://api.creators.yucp.club";
        ...
        public static List<string> GetUrls()
        {
            ...
            try
            {
                ...
                return NormalizeUrls(wrapper.urls);
            }
            catch
            {
        ...
        {
            var wrapper = new UrlListWrapper { urls = NormalizeUrls(urls) };
        ...
        public static bool IsTrustedUrl(string url)
        {
            ...
            return GetUrls().Contains(normalized);
        }
