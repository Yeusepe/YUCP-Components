...
{
    internal static class CallbackPageHtmlBuilder
    {
        /// <summary>
        /// Builds the shared sky/glass-card HTML page used for all local callback responses.
        /// When <paramref name="redirectUrl"/> is supplied the page emits a meta-refresh that
        /// navigates the browser after 1 second, giving the user a brief confirmation glance.
        /// </summary>
