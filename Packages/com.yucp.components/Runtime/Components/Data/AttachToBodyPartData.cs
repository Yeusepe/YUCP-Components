...
namespace YUCP.Components
{
    ...
    public class AttachToBodyPartData : MonoBehaviour, IEditorOnly, IPreprocessCallbackBehaviour
    {
        ...
        {
            // first map part → human bones
            HumanBodyBones leftB, rightB;
            switch (part)
            {
                case BodyPart.UpperLeg: leftB = HumanBodyBones.LeftUpperLeg; rightB = HumanBodyBones.RightUpperLeg; break;
                case BodyPart.LowerLeg: leftB = HumanBodyBones.LeftLowerLeg; rightB = HumanBodyBones.RightLowerLeg; break;
                case BodyPart.Foot: leftB = HumanBodyBones.LeftFoot; rightB = HumanBodyBones.RightFoot; break;
                case BodyPart.Toes: leftB = HumanBodyBones.LeftToes; rightB = HumanBodyBones.RightToes; break;
                case BodyPart.Shoulder: leftB = HumanBodyBones.LeftShoulder; rightB = HumanBodyBones.RightShoulder; break;
                case BodyPart.UpperArm: leftB = HumanBodyBones.LeftUpperArm; rightB = HumanBodyBones.RightUpperArm; break;
                case BodyPart.LowerArm: leftB = HumanBodyBones.LeftLowerArm; rightB = HumanBodyBones.RightLowerArm; break;
                case BodyPart.Hand: leftB = HumanBodyBones.LeftHand; rightB = HumanBodyBones.RightHand; break;
                case BodyPart.ThumbProximal: leftB = HumanBodyBones.LeftThumbProximal; rightB = HumanBodyBones.RightThumbProximal; break;
                case BodyPart.ThumbIntermediate: leftB = HumanBodyBones.LeftThumbIntermediate; rightB = HumanBodyBones.RightThumbIntermediate; break;
                case BodyPart.ThumbDistal: leftB = HumanBodyBones.LeftThumbDistal; rightB = HumanBodyBones.RightThumbDistal; break;
                case BodyPart.IndexProximal: leftB = HumanBodyBones.LeftIndexProximal; rightB = HumanBodyBones.RightIndexProximal; break;
                case BodyPart.IndexIntermediate: leftB = HumanBodyBones.LeftIndexIntermediate; rightB = HumanBodyBones.RightIndexIntermediate; break;
                case BodyPart.IndexDistal: leftB = HumanBodyBones.LeftIndexDistal; rightB = HumanBodyBones.RightIndexDistal; break;
                case BodyPart.MiddleProximal: leftB = HumanBodyBones.LeftMiddleProximal; rightB = HumanBodyBones.RightMiddleProximal; break;
                case BodyPart.MiddleIntermediate: leftB = HumanBodyBones.LeftMiddleIntermediate; rightB = HumanBodyBones.RightMiddleIntermediate; break;
                case BodyPart.MiddleDistal: leftB = HumanBodyBones.LeftMiddleDistal; rightB = HumanBodyBones.RightMiddleDistal; break;
                case BodyPart.RingProximal: leftB = HumanBodyBones.LeftRingProximal; rightB = HumanBodyBones.RightRingProximal; break;
                case BodyPart.RingIntermediate: leftB = HumanBodyBones.LeftRingIntermediate; rightB = HumanBodyBones.RightRingIntermediate; break;
                case BodyPart.RingDistal: leftB = HumanBodyBones.LeftRingDistal; rightB = HumanBodyBones.RightRingDistal; break;
                case BodyPart.LittleProximal: leftB = HumanBodyBones.LeftLittleProximal; rightB = HumanBodyBones.RightLittleProximal; break;
                case BodyPart.LittleIntermediate: leftB = HumanBodyBones.LeftLittleIntermediate; rightB = HumanBodyBones.RightLittleIntermediate; break;
                case BodyPart.LittleDistal: leftB = HumanBodyBones.LeftLittleDistal; rightB = HumanBodyBones.RightLittleDistal; break;
                case BodyPart.Eye: leftB = HumanBodyBones.LeftEye; rightB = HumanBodyBones.RightEye; break;
                default:
                    return Side.Left;
            }

            var leftT = animator.GetBoneTransform(leftB);
            var rightT = animator.GetBoneTransform(rightB);

            // pick side exactly as in ChooseSide
            switch (side)
            {
                case Side.Left:
                    return (leftT != null) ? Side.Left : Side.Right;

                case Side.Right:
                    return (rightT != null) ? Side.Right : Side.Left;

                case Side.Closest:
                    if (leftT == null) return Side.Right;
                    if (rightT == null) return Side.Left;
                    float dL = Vector3.Distance(transform.position, leftT.position);
                    float dR = Vector3.Distance(transform.position, rightT.position);
                    return (dL <= dR) ? Side.Left : Side.Right;
            }
